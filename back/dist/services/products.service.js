...
exports.getProductIdService = exports.getProductsService = exports.checkProductExists = void 0;
...
const getProductIdService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield product_repository_1.ProductRepository.findOne({ where: { id: id } });
});
